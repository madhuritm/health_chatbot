...
GRAPHWEAVER_ROOT = "/home/ec2-user/"
if GRAPHWEAVER_ROOT not in sys.path:
    sys.path.append(GRAPHWEAVER_ROOT)

from Graphweaver.graphRetriever.Text2CypherQuery import text2cypher
from health_chatbot.retrieval_pipeline.inference.config import client, index, chunks_df, embedder
