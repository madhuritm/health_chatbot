...
index=faiss.read_index("../index/test_asthma_index.index")
df=pd.read_json("/home/ec2-user/health_chatbot/embeddings/outputFiles/test_asthma_embeddings.json", lines=True)
metadatas=df[['chunk_id', 'chunk_url', 'chunk_title','chunk_text']]

query="Whom does corona virus disease affect more ?"
